...
from Proyecto_1.views import custom_handler404, agregar_cliente
from .views import tienda, carrito, realizar_compra
...
from Proyecto_1.views import share_facebook, share_instagram, share_tiktok, copy_link
